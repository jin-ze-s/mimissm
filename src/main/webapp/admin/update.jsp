...
<script type="text/javascript">
	function myclose() {
		window.location="${pageContext.request.contextPath}/prod/splitBackPage.action?page="+'${productInfoVo.page}'
        +"&pname="+'${productInfoVo.pname}'+"&typeid="+'${productInfoVo.typeid}'+"&lprice="+'${productInfoVo.lprice}'
        +"&hprice="+'${productInfoVo.hprice}'
		//window.close();
	}
</script>
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update.action" method="post" id="myform">
					...
					<input type="hidden" value="${prod.pImage}" name="pImage" id="pImg">
					<input type="hidden" value="${productInfoVo.page}" name="page">
                    <input type="hidden" value="${productInfoVo.pname}" name="pname">
                    <input type="hidden" value="${productInfoVo.typeid}" name="typeid">
                    <input type="hidden" value="${productInfoVo.lprice}" name="lprice">
                    <input type="hidden" value="${productInfoVo.hprice}" name="hprice">
					<table>
						<tr>
